...
判断の軸について:
- 前日比・1週間騰落率のような短期の値動きは、あくまで参考情報として扱ってください。
...
ただし、上記の「前回終値→今回終値」の変化はあくまで短期の値動きです。中長期トレンド
（3ヶ月・6ヶ月・1年騰落率）に変化が無いにもかかわらず、この短期的な値動きだけを理由に
判断を反転させることのないよう注意してください。
"""
...
- 銘柄自体の3ヶ月・6ヶ月・1年騰落率などの中長期トレンド（前日比・1週間といった
  短期の値動きは参考情報にとどめ、中長期トレンドを主たる判断根拠にすること。
  数日単位の含み損益の変化だけを理由に判断を変えないよう注意する）
